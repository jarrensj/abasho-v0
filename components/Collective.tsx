...
export default function Collective() {
  return (
    <div id='collective' className='min-h-screen px-6 py-24 sm:px-8'>
      <h2 className='text-5xl sm:text-7xl md:text-8xl lg:text-9xl font-custom font-bold tracking-tighter mb-8 md:mb-12'>
        <span className='block'>TALENT IS EVENLY DISTRIBUTED,</span>
        <span className='block'>OPPORTUNITY IS NOT</span>
      </h2>

      <div className='grid grid-cols-1 md:grid-cols-2 items-center gap-10 md:gap-16 xl:gap-24'>
        <div id='collective--textContainer'>
          <div style={{ maxWidth: 1000 }}>
            <p className='leading-relaxed'>
              Abasho Collective exists to change that. Lack of technological
              understanding and misconceptions about NFTs/Crypto keep thousands
              of talented artists from accessing the tremendous opportunities
